...
export default class LegalCookiePage extends React.Component {
				...
				<div className="section-wrapper content">
					<div className="section-content title">
 					...
 					<div className="section-content bubble">
 						<p>This Cookie Policy explains how StreamAchievements ("<strong>Company</strong>", "<strong>we</strong>", "<strong>us</strong>", and "<strong>our</strong>") uses cookies and similar technologies to recognize you when you visit our websites at https://streamachievements.com, ("<strong>Websites</strong>"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
						...
						<p>Cookies set by the website owner (in this case, StreamAchievements) are called "first party cookies". Cookies set by parties other than the website owner are called "third party cookies". Third party cookies enable third party features or functionality to be provided on or through the website (e.g. like advertising, interactive content and analytics). The parties that set these third party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites. </p>
						...
						<p>In addition, most advertising networks offer you a way to opt out of targeted advertising. If you would like to find out more information, please visit <a target="blank" href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</a> or <a target="blank" href="http://www.youronlinechoices.com">http://www.youronlinechoices.com</a>. </p>
						...
						<div className="cookie-table">
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Name:</div>
								<div className="cookie-table--column">etid</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Purpose:</div>
								<div className="cookie-table--column">Provides means of identifying the current user of the website</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Provider:</div>
								<div className="cookie-table--column">.streamachievements.com</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Service:</div>
								<div className="cookie-table--column">StreamAchievements <a href="/legal/privacy-policy">View Service Privacy Policy</a></div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Country:</div>
								<div className="cookie-table--column">United States</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Type:</div>
								<div className="cookie-table--column">http_cookie</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Expires in:</div>
								<div className="cookie-table--column">4h</div>
							</div>
						</div>
						<div className="cookie-table">
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Name:</div>
								<div className="cookie-table--column">__tlbcpv</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Purpose:</div>
								<div className="cookie-table--column">Used to record the cookie consent preferences of visitors</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Provider:</div>
								<div className="cookie-table--column">.termly.io</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Service:</div>
								<div className="cookie-table--column">Termly <a target="blank" href="https://policies.google.com/privacy">View Service Privacy Policy</a></div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Country:</div>
								<div className="cookie-table--column">United States</div>
							...
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Expires in:</div>
								<div className="cookie-table--column">20 years</div>
							</div>
						</div>
						<div className="cookie-table">
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Name:</div>
								<div className="cookie-table--column">__tltpl_#</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Purpose:</div>
								<div className="cookie-table--column">Used to record the policies that visitors consent to</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Provider:</div>
								<div className="cookie-table--column">.termly.io</div>
						...
						<div className="cookie-table">
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Name:</div>
								<div className="cookie-table--column">__tluid</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Purpose:</div>
								<div className="cookie-table--column">Assigns a random ID number to each visitor so that their policy consent and cookie consent preferences can be saved.</div>
							</div>
							<div className="cookie-table--row">
								<div className="cookie-table--column label">Provider:</div>
								<div className="cookie-table--column">.termly.io</div>
						...
						<p>If you do not want Flash Cookies stored on your computer, you can adjust the settings of your Flash player to block Flash Cookies storage using the tools contained in the <a target="blank" href="http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager07.html">Website Storage Settings Panel</a>. You can also control Flash Cookies by going to the <a target="blank" href="http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager03.html">Global Storage Settings Panel</a> and following the instructions (which may include instructions that explain, for example, how to delete existing Flash Cookies (referred to "information" on the Macromedia site), how to prevent Flash LSOs from being placed on your computer without your being asked, and (for Flash Player 8 and later) how to block Flash Cookies that are not being delivered by the operator of the page you are on at the time). </p>
						...
						<p>If you have any questions about our use of cookies or other technologies, please email us at streamachievements.official@gmail.com</p>
 					</div>
				</div>
				<Footer />
			</div>
